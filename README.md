...
After [downloading and flashing](https://cast.otter.jetzt/docs/firmware/#download-ready-made-images) the image, OtterCastAudio can either be configured via the `config.ini` file or via the web-interface.
